...
<% ProductVO productVO = productDAO.findProduct(request.getParameter("prodNo")); %>
<%
	System.out.println("가져오는 값" + productVO);
%>
--%>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text"  name="manuDate" value="${productVO.manuDate}"
