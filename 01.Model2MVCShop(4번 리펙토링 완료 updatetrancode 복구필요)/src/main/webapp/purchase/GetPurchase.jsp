...
구매완료 <a href="/updateTranCode.do?tranCode=${map.list[param.count].proTranCode}&prodNo=${map.list[param.count].prodNo}">배송하기</a>
</c:if>
...
배송중 <a href="/updateTranCode.do?tranCode=${list[param.count].tranCode}&prodNo=${list[param.count].purchaseProd.prodNo}">수취확인</a>
